...
<head>
    ...
    <!-- IF isset title -->
    <title>LKPS | <?php echo (isset($title)?$title:'');?> </title>
    <!-- Favicon-->
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbar-collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="body">
                                <ul class="menu">
                                    <li>
                                        <a href="#" onClick="return false;">
                                            <span class="table-img msg-user">
                                                <img src="<?= base_url() ?>assets/images/user/user1.jpg" alt="">
                                            </span>
                                    ...
                                    <li>
                                        <a href="#" onClick="return false;">
                                            <span class="table-img msg-user">
                                                <img src="<?= base_url() ?>assets/images/user/user2.jpg" alt="">
                                            </span>
                                            <span class="menu-info">
                                    ...
                                    <li>
                                        <a href="#" onClick="return false;">
                                            <span class="table-img msg-user">
                                                <img src="<?= base_url() ?>assets/images/user/user3.jpg" alt="">
                                            </span>
                                            <span class="menu-info">
                                    ...
                                    <li>
                                        <a href="#" onClick="return false;">
                                            <span class="table-img msg-user">
                                                <img src="<?= base_url() ?>assets/images/user/user4.jpg" alt="">
                                            </span>
                                            <span class="menu-info">
                                    ...
                                    <li>
                                        <a href="#" onClick="return false;">
                                            <span class="table-img msg-user">
                                                <img src="<?= base_url() ?>assets/images/user/user5.jpg" alt="">
                                            </span>
                                            <span class="menu-info">
                                    ...
                                    <li>
                                        <a href="#" onClick="return false;">
                                            <span class="table-img msg-user">
                                                <img src="<?= base_url() ?>assets/images/user/user6.jpg" alt="">
                                            </span>
                                            <span class="menu-info">
                                    ...
                                    <li>
                                        <a href="#" onClick="return false;">
                                            <span class="table-img msg-user">
                                                <img src="<?= base_url() ?>assets/images/user/user7.jpg" alt="">
                                            </span>
                                            <span class="menu-info">
                                                <span class="menu-title">John Doe</span>
                                                <span class="menu-desc">
                    ...
                    <!-- #END# Notifications-->
                    <li class="dropdown user_profile mr-5">
                        <a href="#" onClick="return false;" class="dropdown-toggle" data-toggle="dropdown" role="button">
                            <img src="<?= base_url() ?>assets/images/user.jpg" width="32" height="32" alt="User">
                        </a>
                        <ul class="dropdown-menu pullDown">
                            <li class="body">
    ...
    <div>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
              ...
              <!-- Sangat Penting memanggil view sidebar -->
              <?php
